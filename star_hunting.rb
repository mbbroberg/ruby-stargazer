...
webmachine = github.repos.list org: 'webmachine', auto_pagination: true
...
webmachine.each do |repo|
    # Make the call to get all users from the repo
    all_stars = github.activity.starring.list user: 'webmachine', repo: repo.name, auto_pagination: true
