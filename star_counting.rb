...
begin
  ...
  intelsdi = github.repos.list org: 'intelsdi-x', auto_pagination: true
  ...
  intelsdi.each do |repo|
      ...
      all_stars = github.activity.starring.list user: 'intelsdi-x', repo: repo.name, auto_pagination: true
